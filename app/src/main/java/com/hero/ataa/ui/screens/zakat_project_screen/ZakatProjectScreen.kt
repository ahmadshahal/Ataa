...
fun ZakatProjectScreen(
    ...
    Scaffold(
        ...
        topBar = {
            ZakatProjectAppBar(navController = navController, scrollState = scrollState)
        },
...
@Composable
private fun ZakatProjectAppBar(navController: NavController, scrollState: ScrollState) {
    AppBar(
        title = {
            Text(
                text = stringResource(id = R.string.paying_zakat),
...
private fun ContentColumn(chosenAmountIdx: MutableState<Int>, amount: MutableState<String>) {
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.zakat_quote),
