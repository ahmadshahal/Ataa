...
data class Country(
    ...
    companion object {
        ...
        fun getCountriesList(): List<Country> {
            ...
            countries.add(Country("cd", "243", "Congo"))
            ...
            countries.add(Country("io", "246", "British Indian Ocean"))
            ...
            countries.add(Country("la", "856", "Lao People's"))
            ...
            countries.add(Country("va", "379", "Holy See"))
            countries.add(Country("vc", "1", "Saint Vincent"))
